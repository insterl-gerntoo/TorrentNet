...
int main(void)
{
	...
	std::string bigdatatest = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	...
	std::cout << std::endl << std::dec << "length: " << bigdatatest.length() << " " << bigdatatest;
	...
	EndianSwapper::swap_arbitrary((uint8_t*) bigdatatest.c_str(), bigdatatest.length());
